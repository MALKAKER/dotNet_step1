...
namespace BE
{
    ...
    {
        //Fields
        public Dictionary<DayOfWeek, KeyValuePair<int, int>> parentWorkhours { get; set; }//todo
        ...
        public Parent(String myFirstName, String myLastName, String myID, DateTime myDateOfBirth,
            ...
            Address myAreaToSearchNanny, List<String> myChildrenId, String myFirstNameAnotherParent=null, String myLastNameAnotherParent=null, 
             ...
             myEmail, myLandLinePhone, myMobile, myPersonAddress)
        {
            ...
            areaToSearchNanny = myAreaToSearchNanny;
